...
namespace TiaFileFormatExporter.Classes.Converters
{
    ...
    {
        override public IHmiObject Convert(StorageBusinessObject storageBusinessObject, ConvertOptions convertOptions)
        {
            if (storageBusinessObject.GetChild<HmiInternalImageAttributes>() is { } imgDataAttr)
            {
